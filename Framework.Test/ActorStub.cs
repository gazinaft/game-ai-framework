...
public class ActorStub
{
    ...
    public ActorStub(float patrolTime = 25f, float expireTime = 20f)
    {
    ...
    public void Start()
    {
        ...
        var idleLogic = new IdleLogic(1, _expireTime);
        var rageLogic = new RageLogic(5, _expireTime);
        var patrollingLogic = new PatrollingLogic(_patrolTime, 5, _expireTime);
